...
export Customized_Information="OpenWrt_x64 by MOEMR_s1 build $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
...
# 修改插件名字
sed -i 's/"UPnP IGD 和 PCP/NAT-PMP"/"UPnP"/g' `egrep "UPnP IGD 和 PCP/NAT-PMP" -rl ./`
